...
from models.ResNet50 import RetinaDataset, build_resnet50_model
...
if __name__ == "__main__":
    ...
    # Build the ResNet-50 model for binary classification
    ...
    num_epochs = 10
    best_acc = 0.0
    best_model_path = 'models/weights/best_resnet50_model.pth'
    ...
    for epoch in range(num_epochs):
        ...
        val_acc = 100 * correct / total  # Calculate the validation accuracy
